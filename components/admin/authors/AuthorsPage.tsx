...
import { Author, authorsApi } from "@/lib/authors-api";
...
const AuthorsPage: React.FC = () => {
  ...
  const fetchAuthors = useCallback(async () => {
    try {
      ...
      toast.error(err instanceof Error ? err.message : "Failed to fetch authors");
    } finally {
      setLoading(false);
    }
  }, [search, activeFilter]);
  ...
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Authors</h1>
        <p className="text-gray-600">Manage authors for your blog posts and content</p>
      </div>
          ...
          {authors.map((author) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                {author.designation && (
                  <p className="text-sm text-gray-600 mb-2">{author.designation}</p>
                )}
                {author.description && (
