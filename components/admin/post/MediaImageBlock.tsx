...
// Separate React component for the render logic
interface MediaImageBlockProps {
  ...
  editor: {
    updateBlock: (block: unknown, updates: { props: Record<string, string> }) => void;
  };
}

const MediaImageBlockComponent: React.FC<MediaImageBlockProps> = (props) => {
...
export const MediaImageBlock = createReactBlockSpec(
  ...
  {
    // @ts-expect-error BlockNote prop types mismatch
    render: (props) => <MediaImageBlockComponent {...props} />,
  }
);
